...
public class Parameters <T extends Comparable<T>> {
        //declaring instance variables
        Integer[] arrayOfInt;
        Float []  arrayOfFloat;
        String[] arrayOfString;

        public Parameters(Integer[] arrayOfInt, Float[] arrayOfFloat, String[] arrayOfString) {
        ...
        public static void main(String[] args) {
            ...
            new Parameters(a, b, c).testMaximum();
        }
